...
class CorrBalance(Optimizer):
    ...
    """
    def __init__(self, params, corr_factor, relax_factor=0.7, beta=0.9):
        ...
        defaults = dict(relax_factor=relax_factor, beta=beta, corr_factor=corr_factor)
        super(CorrBalance, self).__init__(params, defaults)
        ...
        for group in self.param_groups:
          for p in group['params']:
            ...
            if loss_index == 0:
              ...
              state['sum_gradient'] += co_factor[loss_index] * p.grad
            else:
              state['sum_gradient'] += co_factor[loss_index] * p.grad
